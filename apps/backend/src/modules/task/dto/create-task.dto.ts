...
export class CreateTaskDto {
  ...
  @ApiPropertyOptional({ description: '任务状态', enum: TaskStatus, default: TaskStatus.TODO })
  @IsOptional()
  @IsIn(Object.values(TaskStatus))
  status?: TaskStatus;

  @ApiPropertyOptional({ description: '优先级 1-4（P1-P4）', minimum: 1, maximum: 4, default: 4 })
  @IsOptional()
  @IsNumber()
  @Min(1)
  @Max(4)
